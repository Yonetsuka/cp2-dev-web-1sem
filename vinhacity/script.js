...
function validar()
{
    ...
    else if(nome.lenght > 50)
    {
        alert('Nome muito longo')
    }
    else if(nome.indexOf(1) != -1 || nome.indexOf(2) != -1 ||nome.indexOf(3) != -1 ||nome.indexOf(4) != -1 ||nome.indexOf(5) != -1 ||nome.indexOf(6) != -1 ||nome.indexOf(7) != -1 ||nome.indexOf(8) != -1 ||nome.indexOf(9) != -1)
    {
        alert('Inserir letras')
    }
    else if(telefone.value == "")
    {
        alert('Inserir número de telefone');
    }
    else if(telefone.lenght > 14)
    {
        alert('Número de telefone muito grande')
    }
    else if(email.value == "")
    {
        alert('Inserir email')
